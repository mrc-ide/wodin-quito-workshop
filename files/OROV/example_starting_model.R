...
m = user(10, min=0,max=1000) # density of vectors per person 
a = user(0.03) # biting rate per vector. 1/gonotrophic cycle (1/3days) * proportion of bloodmeals on humans
b_h = 0.5 # probability of infection in susceptible human given bite from infectious vector  
b_v = 0.2 # probability of infection in susceptible vector given bite on an infectious human  
